...
if (!createObject('modNamespace',array(
    'name' => 'commerce_ups',
    'path' => $componentPath.'/core/components/commerce_ups/',
    'assets_path' => $componentPath.'/assets/components/commerce_ups/',
),'name', false)) {
    echo "Error creating namespace commerce_ups.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_ups.core_path',
    'value' => $componentPath.'/core/components/commerce_ups/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_ups',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_ups.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_ups.assets_path',
    'value' => $componentPath.'/assets/components/commerce_ups/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_ups',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_ups.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_ups/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_ups.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_ups',
    'area' => 'Paths',
    ...
    echo "Error creating commerce_ups.assets_url setting.\n";
}
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        ...
        echo "Error creating commerce_ups.".$key." setting.\n";
    }
}
...
include $componentPath . '/core/components/commerce_ups/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_ups/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'PoconoSewVac\\Ups\\Modules\\', $modulePath);
